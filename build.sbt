...
name := "is-odd-or-even-week-slinky"
...
Compile / npmDependencies += "react-date-picker" -> "8.3.4"
Compile / npmDependencies += "ordinal" -> "1.0.3"
Compile / npmDependencies += "react-use-cookie" -> "1.2.1"
...
libraryDependencies += "me.shadaj" %%% "slinky-hot" % "0.6.8"
...
stIgnore := List("typescript", "react-dom", "react-proxy", "ordinal")
